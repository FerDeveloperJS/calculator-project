    ...
    <div className="relative">
      <div className="flex flex-wrap w-60 md:w-80 text-white font-bold gap-2.5">
        <button
          ...
          className="flex justify-center items-center bg-[#333333] w-14 h-14  md:w-20 md:h-20 p-1.5 text-2xl rounded-full"
        >
          7
        </button>
      ...
      <div className="mt-2.5 flex gap-2.5 text-white">
        <button
          ...
          className="flex justify-center items-center rounded-full p-1.5 w-14 h-14 md:w-20 md:h-20  text-4xl font-extrabold bg-[#A26BFF]"
        >
          +
        </button>
      ...
      <div className="absolute flex flex-col gap-2.5 top-0 right-0 h-64 rounded-full text-white font-bold">
        <button
          ...
          className="text-4xl w-14 h-14 md:w-20 md:h-20  p-1.5 rounded-full bg-[#A26BFF]"
        >
          {" "}
          ={" "}
        </button>
        ...
        <button
          onClick={() => setScreen(screen + ".")}
          className="text-4xl w-14 h-14 md:w-20 md:h-20  p-1.5 rounded-full bg-[#333333]"
        >
          ,
        </button>
...
export default CalculatorDarkMode;
